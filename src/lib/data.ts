...
export const profile = {
  ...
  education: "MS in Management of Technology, NYU (May 2026)",
  priorDegree: "BE in Computer Science, Ramaiah Institute of Technology",
};
...
export const work: WorkItem[] = [
  {
    ...
    kind: "experience",
    title: "Accenture",
    subtitle: "Product & Strategy Associate · Financial Services Consulting",
  ...
  },
  {
    ...
    caseStudy: {
      ...
      whatIDid: [
        ...
        "Built a transparent 0–100 risk score weighting self-closing-door violations, complaint history, and building age, with every input visible and defensible rather than a black box.",
